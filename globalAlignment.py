...
def create_score_matrix(s1len, s2len):
    ...
    print("Global alignment score is:" + str(scoreMatrix[-1][-1]))
...
def traceback():
    ...
    alignedS1 = ""
    alignedS2 = ""
    create_score_matrix(len(s1), len(s2))
