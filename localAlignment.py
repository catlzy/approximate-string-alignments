...
#create the dynamic programming table, return the position of the max score
...
#traceback from the position of the max score to find the alignmnet
def traceback():
    global s1, s2, scoreTable, p
    alignedS1 = ""
    alignedS2 = ""
    (row, col) = create_score_table(len(s1), len(s2))
...
if __name__ == "__main__":
    ...
    traceback()
    # ye with modern: 15809
    # yp with modern: 20779
